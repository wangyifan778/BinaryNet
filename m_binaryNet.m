...
image = bn_m1(image, beta, gamma, tmean, tvariance);
...
image = bn_m(image, beta, gamma, tmean, tvariance);
...
image = fc_bn_m(image, beta, gamma, tmean, tvariance);
...
%bn_merge
function [image] = bn_m(image, beta, gamma, tmean, tvariance)
 [~, ~, filters] = size(image);
 eps = 1.0e-8;
 X = zeros(filters,1);
 S = zeros(filters,1);
...
function [image] = bn_m1(image, beta, gamma, tmean, tvariance)
 [~, ~, filters] = size(image);
 eps = 1.0e-8;
 X = zeros(filters,1);
 S = zeros(filters,1);
...
%fc_bn _merge
function [image] = fc_bn_m(image, beta, gamma, tmean, tvariance)
 [~, filters] = size(image);
 eps = 1.0e-8;
 X = zeros(filters,1);
 S = zeros(filters,1);
